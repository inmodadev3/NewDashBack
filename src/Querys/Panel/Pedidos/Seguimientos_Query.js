        ...
        try {
            ...
            if (seguimiento.length == 0) {
                ...
                await obtenerDatosDb_Dash(actualizar, [
                    ...
                    Pago,
                    TipoVenta,
                    (parseInt(Encargado_Alistamiento1) !== 0 && Encargado_Alistamiento1 !== null) ? parseInt(Encargado_Alistamiento1) : null,
                    (parseInt(Encargado_Alistamiento2) !== 0 && Encargado_Alistamiento2 !== null) ? parseInt(Encargado_Alistamiento2) : null,
                    (parseInt(Encargado_Alistamiento3) !== 0 && Encargado_Alistamiento3 !== null) ? parseInt(Encargado_Alistamiento3) : null,
                    (parseInt(Encargado_Revision) !== 0 && Encargado_Revision !== null) ? parseInt(Encargado_Revision) : null,
                    (parseInt(Encargado_Facturacion) !== 0 && Encargado_Facturacion !== null) ? parseInt(Encargado_Facturacion) : null,
                    TipoEnvio,
                    //(NroGuia !== null && NroGuia !== "") ? parseInt(NroGuia) : null,
                    NroGuia,
                    Despacho,
